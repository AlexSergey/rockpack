import React, { useContext, useCallback, createElement } from 'react';
import dayjs from 'dayjs';
import platform from 'platform';
import isMobile from 'is-mobile';
import logger, { LoggerContainer, LoggerContext } from '../../../src';
...
export default function() {
    ...
    return <>
        ...
        >
            {createElement(() => {
                let ctx = useContext(LoggerContext);
                ...
                return <>
                    ...
                    <div>
                        ...
                        <button className="btn btn-primary mb-2" onClick={() => console.log(ctx.getStackData())}>
                            Show logger stack
                        </button>
                    </div>
                </>
