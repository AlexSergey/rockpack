...
export const createDocumentation = (props, el) => {
    ...
    render((React.createElement(Router, { history: history },
        React.createElement(LangWrapper, Object.assign({}, props), (isLocalized, activeLang, changeLocal) => (React.createElement(OpenIds, Object.assign({}, props, { openIds: openIds }), (openIds, setOpenIds) => (React.createElement(Layout, Object.assign({}, Object.assign({}, props, {
            openIds,
            hasRoutes,
            isLocalized,
            activeLang,
