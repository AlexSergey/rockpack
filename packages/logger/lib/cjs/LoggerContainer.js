...
exports.useLogger = function () { return react_1.useContext(exports.LoggerContext).getLogger(); };
...
var LoggerContainer = /** @class */ (function (_super) {
    ...
    function LoggerContainer(props) {
        ...
        _this.getLogger = function () { return _this.props.logger; };
    ...
    LoggerContainer.prototype.render = function () {
        ...
        return (react_1["default"].createElement(exports.LoggerContext.Provider, { value: {
            ...
            this.props.children,
            this.props.bsodActive && this.state.bsod && (react_1["default"].createElement(Bsod, { count: this.getLogger().getCounter(), onClose: this.closeBsod, stackData: this.getStackData() }))));
    };
