...
const OnComplete = ({
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    if (!Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isBackend"])() && init) {
      setSkipState(false);
    }
  }, []);
  return null;
...
const createUssr = initState => {
  ...
  return [runEffects, ({
    ...
    const [skipEffectsInClient, setSkipState] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(!Object(_utils__WEBPACK_IMPORTED_MODULE_1__["isBackend"])());
...
const useUssrEffect = (path, defaultValue) => {
  ...
  if (!Object(_utils__WEBPACK_IMPORTED_MODULE_4__["isBackend"])()) {
...
//# sourceMappingURL=index.b088461d388eada21095.hot-update.js.map