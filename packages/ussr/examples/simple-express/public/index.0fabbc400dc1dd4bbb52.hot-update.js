...
const useUssrEffect = (path, defaultValue) => {
  ...
  return [state, _setState, cb => {
    if (skipEffectsOnClient) {
      return false;
    }

    console.log(!skipEffectsOnClient);

    if (!skipEffectsOnClient && !Object(_utils__WEBPACK_IMPORTED_MODULE_4__["isBackend"])() && initHook.current && typeof cb === 'function') {
      cb();
...
//# sourceMappingURL=index.0fabbc400dc1dd4bbb52.hot-update.js.map