...
const useUssrEffect = (path, defaultValue) => {
  ...
  const setOnTheClientAfterBackendRender = !Object(_utils__WEBPACK_IMPORTED_MODULE_4__["isBackend"])() && !skipEffectsOnClient && initHook.current;
  ...
  return [state, _setState, cb => {
    ...
    if (!Object(_utils__WEBPACK_IMPORTED_MODULE_4__["isBackend"])() && initHook.current && typeof cb === 'function') {
      cb();
      initHook.current = false;
    }
...
//# sourceMappingURL=index.5d69b231e09c43c8f0ce.hot-update.js.map