...
/*!
 * banner:
 * @rock/ussr-client: 0.9.0
 * Aleksandrov Sergey <gooddev.sergey@gmail.com> (https://github.com/AlexSergey/localazer)
 * MIT
 */
!function (t, n) {
   true ? module.exports = n(__webpack_require__("../../../../node_modules/react/index.js")) : undefined;
}(this, function (t) {
  return function (t) {
    var n = {};
    ...
    var e = this && this.__importStar || function (t) {
    ...
    n.default = function (t) {
      ...
      return [function () {
        return new Promise(function (t) {
          return Promise.all(r.effects).then(function () {
            return t(u.clone(r.state));
          });
        });
      }, function (r) {
        var u = r.children;
        return o.default.createElement(n.UssrContext.Provider, {
          value: {
            initState: t,
            addEffect: e
          }
    ...
    var o = e(r(9)),
        u = r(17);
    n.useUssrEffect = u.useUssrEffect, n.default = o.default;
  }, function (t, n, r) {
    "use strict";

    n.__esModule = !0, n.isBackend = function () {
    ...
    n.useUssrEffect = function (t, n) {
      var r = o.useContext(c.UssrContext),
          e = r.initState,
          f = r.addEffect,
          s = u.default(e, t, n),
          p = o.useState(s),
      ...
      return [l, function (n, r) {
        i.default(e, t, n), r || v(n);
      }, function (t) {
        if (a) {
          var n = t();
          a = !1, "function" == typeof n.then && f(n);
        }
      }];
    };
  }, function (t, n, r) {
    ...
    t.exports = function (t, n, r, a) {
      ...
      for (var f = -1, s = (n = o(n, t)).length, p = s - 1, l = t; null != l && ++f < s;) {
        var v = c(n[f]),
            d = r;

        if (f != p) {
          var h = l[v];
          void 0 === (d = a ? a(h, v, l) : void 0) && (d = i(h) ? h : u(n[f + 1]) ? [] : {});
        }
...
const App = () => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, state.test), typeof children === 'function' ? children(setState) : children);
};

/***/ })

})
//# sourceMappingURL=index.83e956e06c4189106f8b.hot-update.js.map