    ...
    describe.each([true, false])('generate project with tests or without tests', (tests) => {
      ...
      describe('tests generated project', () => {
        ...
        it('exists lint files', async () => {
          ...
          const eslint = await exists(join(genFolder, projectFolder, 'eslint.config.ts'));
          const eslintflatignore = await exists(join(genFolder, projectFolder, '.eslintflatignore'));
          ...
          expect(eslintflatignore).toBeTruthy();
