...
Requirements: Node.js 24.15 or newer (`.nvmrc` pins the major, 24) and npm 11. `npm install` also installs the git hooks: `pre-commit` lints the staged files, `pre-push` runs the full lint and the unit tests.
